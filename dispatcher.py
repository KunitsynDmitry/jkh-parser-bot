...
def dynamic_prompt(ctx: RunContext[str]) -> str:
    ...
    return (
        ...
        "В location_details всегда используй ЦИФРЫ, а не слова: пиши '2-й этаж' а не 'второй этаж', '3-й подъезд' а не 'третий подъезд'. "
        "Даже если в жалобе число написано словом («второго этажа») — переведи его в цифру ('2-й этаж'). "
